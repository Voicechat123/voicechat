...
"[project]/Documents/voicechat/pages/auth/callback.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        "AuthCallback.useEffect": ()=>{
            const handleCallback = {
                "AuthCallback.useEffect.handleCallback": async ()=>{
                    ...
                    const { data: { session }, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$voicechat$2f$lib$2f$supabaseClient$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
                    if (error || !session) {
                        // Token mógł już być w hash — poczekaj chwilę na przetworzenie
                        setTimeout({
                            "AuthCallback.useEffect.handleCallback": async ()=>{
                                const { data: { session: retrySession } } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$voicechat$2f$lib$2f$supabaseClient$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
                                if (!retrySession) {
                                    router.replace('/');
                                    return;
                                }
                        ...
                        }["AuthCallback.useEffect.handleCallback"], 1000);
                        return;
                    }
            ...
            const checkProfile = {
                "AuthCallback.useEffect.checkProfile": async (user)=>{
            ...
            }["AuthCallback.useEffect.checkProfile"];
            // Supabase obsługuje hash token automatycznie przez onAuthStateChange
            const { data: { subscription } } = __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$voicechat$2f$lib$2f$supabaseClient$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange({
                "AuthCallback.useEffect": async (event, session)=>{
            ...
            handleCallback();
            return ({
                "AuthCallback.useEffect": ()=>subscription.unsubscribe()
            })["AuthCallback.useEffect"];
        }
    }["AuthCallback.useEffect"], [
        router
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$voicechat$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$voicechat$2f$node_modules$2f$next$2f$head$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"], {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$voicechat$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("title", {
                    ...
                    fileName: "[project]/Documents/voicechat/pages/auth/callback.js",
                    lineNumber: 63,
                    columnNumber: 13
                }, this)
            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$voicechat$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$voicechat$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Weryfikacja tożsamości..."
                    }, void 0, false, {
                        fileName: "[project]/Documents/voicechat/pages/auth/callback.js",
                        lineNumber: 69,
                        columnNumber: 9
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/Documents/voicechat/pages/auth/callback.js [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const PAGE_PATH = "/auth/callback";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/Documents/voicechat/pages/auth/callback.js [client] (ecmascript)");
    }
]);
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/Documents/voicechat/pages/auth/callback.js\" }", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/Documents/voicechat/pages/auth/callback.js [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__59dfa78c._.js.map