...
"[project]/Documents/voicechat/pages/auth/callback.js [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AuthCallback() {
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        const handleCallback = async ()=>{
            ...
            const { data: { session }, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$voicechat$2f$lib$2f$supabaseClient$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
            if (error || !session) {
                // Token mógł już być w hash — poczekaj chwilę na przetworzenie
                setTimeout(async ()=>{
                    const { data: { session: retrySession } } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$voicechat$2f$lib$2f$supabaseClient$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
                    if (!retrySession) {
                        router.replace('/');
                        return;
                    }
        ...
        const { data: { subscription } } = __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$voicechat$2f$lib$2f$supabaseClient$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange(async (event, session)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e6dd6264._.js.map